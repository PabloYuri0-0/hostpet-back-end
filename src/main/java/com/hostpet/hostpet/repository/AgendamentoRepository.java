...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Integer> {
    ...
    @Query("SELECT COUNT(a) FROM Agendamento a WHERE a.dataHoraInicio >= :start AND a.dataHoraInicio < :end")
    Integer getCheckinsHoje(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);

    @Query("SELECT COUNT(a) FROM Agendamento a WHERE a.dataHoraFim >= :start AND a.dataHoraFim < :end")
    Integer getCheckoutsHoje(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);


    @Query("SELECT COUNT(a) FROM Agendamento a WHERE a.dataHoraInicio >= :start AND a.dataHoraInicio < :end ")
    Integer getTotalHospedadoHotel(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
}
